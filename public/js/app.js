  ...
  return _c("div", { staticClass: "di relative" }, [
    ...
    _vm.user.permission_level <= 200
      ...
      : _c(
          ...
          [_vm._v(_vm._s(_vm.$t("employee.team_blank")))]
        ),
    _vm._v(" "),
    _vm.modal
      ? _c(
