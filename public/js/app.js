  ...
  methods: {
    submit: function submit() {
      ...
      axios.post('/' + this.company.id + '/account/positions', this.form).then(function (response) {
        _this.$snotify.success(_this.$t('account.position_success_new'), {
          timeout: 5000,
          showProgressBar: true,
          closeOnClick: true,
          pauseOnHover: true
    ...
    update: function update(id) {
      ...
      axios.put('/' + this.company.id + '/account/positions/' + id, this.form).then(function (response) {
        _this2.$snotify.success(_this2.$t('account.position_success_update'), {
          timeout: 5000,
          showProgressBar: true,
          closeOnClick: true,
          pauseOnHover: true
    ...
    destroy: function destroy(id) {
      ...
      axios.delete('/' + this.company.id + '/account/positions/' + id).then(function (response) {
        _this3.$snotify.success(_this3.$t('account.position_success_destroy'), {
          timeout: 5000,
          showProgressBar: true,
          closeOnClick: true,
          pauseOnHover: true
...
// module
exports.push([module.i, "\n.positions-list[data-v-40994ff8] {\n  max-height: 150px;\n}\n.popupmenu[data-v-40994ff8] {\n  right: 2px;\n  top: 26px;\n  width: 280px;\n}\n.c-delete[data-v-40994ff8]:hover {\n  border-bottom-width: 0;\n}\n", ""]);
