...
//
/* harmony default export */ __webpack_exports__["default"] = ({
  props: ['company', 'user', 'nbEmployees']
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  props: ['company', 'user', 'employee', 'managers', 'directReports'],
  directives: {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  props: ['text', 'state', 'classes', 'cypressSelector'],
  methods: {}
});
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "cf mt3 mw7 center" }, [
      _c("p", [
        _vm._v(
          "You have been invited to join the human resource software used by Behaviour."
        )
      ]),
      _vm._v(" "),
      _c("p", [
        _vm._v("To accept the invitation, use one of these two options below.")
      ])
    ])
  }
]
...
var render = function() {
  ...
  return _c("div", { staticClass: "mb4 relative" }, [
    _c("span", { staticClass: "tc db b mb2" }, [
    ...
    _c("div", { staticClass: "br3 bg-white box z-1 pa3 list-employees" }, [
      _vm.managers.length == 0 && _vm.directReports.length == 0
        ? _c("p", { staticClass: "lh-copy mb0 f6" }, [
            _vm._v(_vm._s(_vm.$t("employee.hierarchy_blank")))
          ])
        : _vm._e(),
      _vm._v(" "),
      _c(
...
var render = function() {
  ...
  return _c(
    "layout",
    { attrs: { title: "Home", noMenu: "true", user: _vm.user } },
    [
      _c("div", { staticClass: "ph2 ph0-ns" }, [
        _c(
          "div",
