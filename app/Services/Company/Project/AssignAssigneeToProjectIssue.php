...
class AssignAssigneeToProjectIssue extends BaseService
{
    ...
    {
        $this->projectIssue->assignees()->syncWithoutDetaching([$this->employee->id]);
    }
    ...
    private function log(): void
    {
        LogAccountAudit::dispatch([
            ...
            'action' => 'project_issue_assigned_to_assignee',
