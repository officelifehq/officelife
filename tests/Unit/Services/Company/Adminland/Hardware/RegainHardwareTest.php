...
class RegainHardwareTest extends TestCase
{
    use DatabaseTransactions;

    /** @test */
    public function it_takes_back_a_hardware_as_administrator(): void
    {
    ...
    /** @test */
    public function it_takes_back_a_hardware_as_hr(): void
    {
    ...
    private function executeService(Employee $michael, Employee $dwight, Hardware $hardware): void
    {
        ...
        (new RegainHardware)->execute($request);
        ...
        Queue::assertPushed(LogAccountAudit::class, function ($job) use ($michael, $dwight, $hardware) {
            return $job->auditLog['action'] === 'hardware_regained' &&
