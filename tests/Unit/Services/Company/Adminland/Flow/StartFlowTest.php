...
use App\Services\Company\Adminland\Flow\StartFlow;
use Illuminate\Foundation\Testing\DatabaseTransactions;
use Illuminate\Database\Eloquent\ModelNotFoundException;

class StartFlowTest extends TestCase
{
    use DatabaseTransactions;

    /** @test */
    public function it_starts_a_flow_as_administrator(): void
    {
    ...
    /** @test */
    public function it_starts_a_flow_as_hr(): void
    {
        Carbon::setTestNow(Carbon::create(2018, 1, 1));
    ...
    /** @test */
    public function it_starts_a_flow_as_normal_user(): void
    {
        Carbon::setTestNow(Carbon::create(2018, 1, 1));
    ...
    private function executeService(Employee $michael, Flow $flow, ScheduledAction $oldScheduledAction): void
    {
        ...
        $flow = (new StartFlow)->execute($request);
        ...
        Queue::assertPushed(LogAccountAudit::class, function ($job) use ($michael, $flow) {
            return $job->auditLog['action'] === 'flow_started' &&
