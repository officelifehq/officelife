...
class SetHiringDateTest extends TestCase
{
    use DatabaseTransactions;

    /** @test */
    public function it_sets_the_hiring_date_of_the_employee_as_administrator(): void
    {
    ...
    /** @test */
    public function it_sets_the_hiring_date_of_the_employee_as_hr(): void
    {
    ...
    private function executeService(Employee $michael, Employee $employeeToUpdate): void
    {
        ...
        $employeeToUpdate = (new SetHiringDate)->execute($request);
