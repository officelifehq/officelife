...
class RejectTimesheetTest extends TestCase
{
    ...
    /** @test */
    public function it_rejects_a_timesheet_as_hr(): void
    {
        Carbon::setTestNow(Carbon::create(2018, 1, 1));
    ...
    /** @test */
    public function it_cant_reject_a_timesheet_as_regular_user(): void
    {
        Carbon::setTestNow(Carbon::create(2018, 1, 1));
    ...
    /** @test */
    public function normal_user_cant_reject_a_timesheet_on_behalf_of_another_employee(): void
    {
        Carbon::setTestNow(Carbon::create(2018, 1, 1));
    ...
    /** @test */
    public function a_manager_can_reject_the_timesheet_of_one_of_his_employee(): void
    {
        Carbon::setTestNow(Carbon::create(2018, 1, 1));
    ...
    public function it_fails_if_wrong_parameters_are_given(): void
    {
        ...
        (new RejectTimesheet)->execute($request);
    }
    ...
    private function executeService(Employee $author, Employee $employee, Timesheet $timesheet): void
    {
        ...
        $timesheet = (new RejectTimesheet)->execute($request);
        ...
        Queue::assertPushed(LogAccountAudit::class, function ($job) use ($author, $employee, $timesheet) {
            return $job->auditLog['action'] === 'timesheet_rejected' &&
