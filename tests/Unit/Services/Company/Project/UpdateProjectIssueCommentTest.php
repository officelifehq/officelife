...
use App\Services\Company\Project\UpdateProjectIssueComment;

class UpdateProjectIssueCommentTest extends TestCase
{
    use DatabaseTransactions;

    /** @test */
    public function it_updates_an_issue_to_a_project_as_administrator(): void
    {
    ...
    /** @test */
    public function it_updates_an_issue_to_a_project_as_hr(): void
    {
    ...
    /** @test */
    public function it_updates_an_issue_to_a_project_as_normal_user(): void
    {
    ...
    public function it_fails_if_wrong_parameters_are_given(): void
    {
        ...
        (new UpdateProjectIssueComment)->execute($request);
    }
    ...
    private function executeService(Employee $michael, Project $project, ProjectIssue $projectIssue, Comment $comment): void
    {
        ...
        $comment = (new UpdateProjectIssueComment)->execute($request);
        ...
        Queue::assertPushed(LogAccountAudit::class, function ($job) use ($michael, $project, $projectIssue) {
            return $job->auditLog['action'] === 'project_issue_comment_updated' &&
