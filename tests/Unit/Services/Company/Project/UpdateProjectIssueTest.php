...
use App\Services\Company\Project\UpdateProjectIssue;
use Illuminate\Foundation\Testing\DatabaseTransactions;
use Illuminate\Database\Eloquent\ModelNotFoundException;

class UpdateProjectIssueTest extends TestCase
{
    use DatabaseTransactions;

    /** @test */
    public function it_updates_the_project_issue_as_administrator(): void
    {
    ...
    /** @test */
    public function it_updates_the_project_issue_as_hr(): void
    {
    ...
    /** @test */
    public function it_updates_the_project_issue_as_normal_user(): void
    {
    ...
    public function it_fails_if_wrong_parameters_are_given(): void
    {
        ...
        (new UpdateProjectIssue)->execute($request);
    }
    ...
    private function executeService(Employee $michael, Project $project, ProjectIssue $issue): void
    {
        ...
        $issue = (new UpdateProjectIssue)->execute($request);
