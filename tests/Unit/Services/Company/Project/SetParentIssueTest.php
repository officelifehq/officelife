...
use App\Services\Company\Project\SetParentIssue;
use Illuminate\Foundation\Testing\DatabaseTransactions;
use Illuminate\Database\Eloquent\ModelNotFoundException;

class SetParentIssueTest extends TestCase
{
    use DatabaseTransactions;

    /** @test */
    public function it_sets_a_parent_issue_as_administrator(): void
    {
    ...
    /** @test */
    public function it_sets_a_parent_issue_as_hr(): void
    {
    ...
    /** @test */
    public function it_sets_a_parent_issue_as_normal_user(): void
    {
    ...
    public function it_fails_if_wrong_parameters_are_given(): void
    {
        ...
        (new SetParentIssue)->execute($request);
    }
    ...
    private function executeService(Employee $michael, Project $project, ProjectIssue $parentIssue, ProjectIssue $childIssue): void
    {
        ...
        $this->assertDatabaseHas('project_issue_parents', [
            'parent_project_issue_id' => $parentIssue->id,
        ...
        Queue::assertPushed(LogAccountAudit::class, function ($job) use ($michael, $project, $parentIssue, $childIssue) {
            return $job->auditLog['action'] === 'project_issue_parent_set' &&
