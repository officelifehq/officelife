...
use App\Services\Company\Project\UpdateProjectSprint;
use Illuminate\Foundation\Testing\DatabaseTransactions;
use Illuminate\Database\Eloquent\ModelNotFoundException;

class UpdateProjectSprintTest extends TestCase
{
    use DatabaseTransactions;

    /** @test */
    public function it_updates_the_project_sprint_as_administrator(): void
    {
    ...
    /** @test */
    public function it_updates_the_project_sprint_as_hr(): void
    {
    ...
    /** @test */
    public function it_updates_the_project_sprint_as_normal_user(): void
    {
    ...
    public function it_fails_if_wrong_parameters_are_given(): void
    {
        ...
        (new UpdateProjectSprint)->execute($request);
    }
    ...
    private function executeService(Employee $michael, Project $project, ProjectSprint $sprint): void
    {
        ...
        $sprint = (new UpdateProjectSprint)->execute($request);
        ...
        Queue::assertPushed(LogAccountAudit::class, function ($job) use ($michael, $project, $sprint) {
            return $job->auditLog['action'] === 'project_sprint_updated' &&
