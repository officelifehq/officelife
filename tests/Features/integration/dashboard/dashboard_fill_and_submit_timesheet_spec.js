describe('Dashboard - employee - manage time tracking', function () {
  it('should let the employee in an admin role enter his time and submit the timesheet to a manager', function () {
    cy.loginLegacy();
  ...
  it.skip('should let the employee in an HR role enter his time and submit the timesheet to a manager', function () {
    cy.loginLegacy();
  ...
  it.skip('should let a normal employee enter his time and submit the timesheet to a manager', function () {
    cy.loginLegacy();
