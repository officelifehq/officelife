...
describe('Company - Skills', function () {
  it('should let you see all the skills in the company on the company page as an administrator', function () {
    ...
    cy.createCompany(companyName, (companyId) => {
      ...
      cy.visit(`/${companyId}/employees/1`);
      ...
      cy.visit(`/${companyId}/employees/2`);
      cy.get('[data-cy=manage-skill-button]').click();
      cy.get('[data-cy=search-skill]').type('php');
      ...
      // rename a skill
      cy.visit(`/${companyId}/company/skills/1`);
      ...
      cy.hasAuditLog('Updated the skill’s name from php to java', `/${companyId}/company/skills/1`);
      ...
      cy.hasAuditLog('Deleted the skill called java', `/${companyId}/company/skills/1`);
    });
  });
