...
return [
    ...
    'home_manage_employees' => 'Ajouter/retirer des employé·e·s existant·e·s',
    'home_manage_positions' => 'Ajouter/retirer des postes',
    'home_manage_teams' => 'Ajouter/retirer des équipes',
    'home_manage_flows' => 'Ajouter/supprimer des flux',
    'home_manage_employee_statuses' => 'Ajouter/retirer des statuts d’employé·e·s',
    'home_company_news' => 'Ajouter/retirer des nouvelles sur l’entreprise',
    ...
    'team_confirm_deletion' => 'Êtes-vous sûr de vouloir supprimer l’équipe appelée {nom} ? Cela supprimera tous les membres de cette équipe, ainsi que toutes les notes, les nouvelles et les données qui lui sont associées.',
    ...
    'log_expense_category_created' => 'Création d’une catégorie de dépenses appelée :name.',
    'log_expense_category_updated' => 'Mise à jour du nom de la catégorie de dépenses de :old_name à :new_name.',
    'log_expense_category_destroyed' => 'Suppression de la catégorie de dépenses appelée :name.',
    ...
    'log_project_task_udpated' => 'A mis à jour la tâche appelée :project_task_title dans le projet appelé :project_name.',
    ...
    'employee_log_manager_unassigned' => 'A supprimé :name comme gestionnaire.',
    ...
    'notification_expense_assigned_for_validation' => 'Vous avez une nouvelle dépense à valider pour :name.',
    'notification_expense_accepted_by_manager' => 'Votre dépense appelée :title a été acceptée par votre responsable et est maintenant entre les mains du service comptable.',
    'notification_expense_rejected_by_manager' => 'Votre dépense intitulée :title a été rejetée par votre responsable.',
    'notification_employee_allowed_to_manage_expenses' => 'Vous êtes maintenant autorisé à gérer les dépenses de l’entreprise.',
    'notification_expense_accepted_by_accounting' => 'Votre dépense intitulée : title a été approuvée par le service comptable.',
    'notification_expense_rejected_by_accounting' => 'Votre dépense intitulée :title a été rejetée par le service comptable.',
    'morale_1' => 'Positif',
    'morale_2' => 'Neutre',
    'morale_3' => 'Négatif',
    'company_news_title' => 'Nouvelles de l’entreprise',
    'company_news_blank' => 'Avez-vous besoin de diffuser une annonce ou une nouvelle à tous les employés de votre entreprise ? Vous pouvez le faire ici !',
    ...
    'questions_blank' => 'Posez des questions sur vos collègues afin qu’ils puissent mieux se connaître.',
    ...
    'expense_employees_headline' => 'Employés capables de gérer les notes de frais',
    'expense_employees_blank' => 'Aucun employé n’a le droit de gérer les notes de frais à l’heure actuelle.',
    ...
    'general_currency_information_table' => 'Principale devise de l’entreprise',
    ...
    'log_employee_joined_company' => 'A rejoint l’entreprise appelée :company_name.',
];
