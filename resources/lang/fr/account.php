...
return [
    ...
    'home_role_owner' => 'En tant que <span class="fw5 brush-orange">propriétaire</span>, vous pouvez…',
    'home_manage_employees' => 'Ajouter/retirer des employés existants',
    'home_manage_positions' => 'Ajouter/retirer des postes',
    'home_manage_teams' => 'Ajouter/retirer des équipes',
    'home_manage_flows' => 'Ajouter/retirer des flux',
    'home_manage_employee_statuses' => 'Ajouter/retirer des statuts d\'employés',
    'home_company_news' => 'Ajouter/retirer des nouvelles sur les entreprises',
    ...
    'home_manage_expenses' => 'Gérer les dépenses',
    'home_general_settings' => 'Paramètres généraux',
    'home_manage_ecoffee' => 'Gérer le processus eCoffee',
    'home_cancel_account' => 'Annuler ce compte',
    'employees_title' => 'Gérer les employés de {company}',
    'employees_all_title' => 'Tous les employés de {company}',
    'employees_permission_title' => 'Tous les employés triés par permission dans {company}',
    'employees_all_active_title' => 'Tous les employés actifs de {company}',
    'employees_all_locked_title' => 'Tous les employés verrouillés de {company}',
    'employees_all_no_hiring_date_title' => 'Tous les employés sans date d’embauche dans {company}',
    'employees_description_1' => 'Afficher tous les employés',
    'employees_description_2' => 'Ou filtrez les employés correspondant à un critère donné',
    'employees_description_3' => 'Autres actions',
    'employees_cta' => 'Ajouter un seul employé',
    'employees_cta_view_all_employees' => 'Afficher tous les employés ({count})',
    'employees_cta_view_active_employees' => 'Afficher uniquement les employés actifs ({count})',
    'employees_cta_view_locked_employees' => 'Afficher uniquement les employés verrouillés ({count})',
    'employees_cta_view_employees_without_hiring_date' => 'Afficher les employés sans date d’embauche ({count})',
    'employees_view_profile' => 'Afficher le profil',
    'employees_invite_user' => 'Inviter un employé',
    'employees_lock_account' => 'Verrouiller le compte',
    'employees_unlock_account' => 'Déverrouiller le compte',
    'employees_change_permission' => 'Modifier l’autorisation',
    'employees_number_employees' => '{company} a un employé.|{company} a {count} employés.',
    'employees_import' => 'Importer un groupe d’employés en une seule fois (dans un fichier CSV)',
    'employees_view_past_imports' => 'Afficher les importations passées',
    'employees_invite_title' => 'Inviter {name} à devenir un utilisateur d’OfficeLife',
    ...
    'employee_delete_success' => 'L’employé a été supprimé avec succès.',
    ...
    'employee_lock_success' => 'L’employé a été verrouillé avec succès.',
    ...
    'employee_unlock_success' => 'L’employé a été débloqué avec succès.',
    'employee_permission_safest' => 'le choix le plus sûr',
    'employee_permission_title' => 'Changer les permissions de {name}',
    'employee_permission_success' => 'L’employé a été mis à jour.',
    'employee_new_basic_information' => 'Informations sur les employés',
    'employee_new_title' => 'Ajouter un employé à {name}',
    'employee_new_firstname' => 'Prénom',
    'employee_new_lastname' => 'Nom de famille',
    'employee_new_email' => 'Adresse courriel',
    'employee_new_hiring_date' => 'Quand l’employé commencera-t-il ?',
    'employee_new_permission_level' => 'Permissions',
    'employee_new_administrator' => 'Administrateur',
    'employee_new_hr' => 'Représentant des Ressources Humaines',
    'employee_new_user' => 'Employé',
    'employee_new_administrator_desc' => 'Peut tout faire, y compris la gestion des comptes. Attention : l’employé aura accès à tout, y compris à toutes les données privées des autres employés.',
    ...
    'employee_new_user_desc' => 'Peut voir toutes les équipes et les employés, mais ne peut pas gérer le compte ou lire les informations privées.',
    'employee_new_send_email' => 'Envoyez un courriel à cette personne avec un lien pour configurer le compte.',
    'employee_new_send_email_optional' => 'C\'est facultatif – vous pourrez inviter cette personne plus tard.',
    'employee_new_success' => 'L’employé a été ajouté.',
