  ...
  <div class="cf mt4 mw7 center br3 mb3 bg-white box">
    <div class="pa3">
      ...
      <form method="POST" action="{{ tenant('/account/employees') }}">
        ...
        {{-- First name --}}
        <div class="">
          <label class="db fw4 lh-copy f6" for="first_name">{{ trans('employee.new_firstname') }}</label>
          <input type="text" name="first_name" class="br2 f5 w-100 ba b--black-40 pa2 outline-0" value="{{ old('first_name') }}" required>
        </div>

        {{-- Last name --}}
        <div class="">
          <label class="db fw4 lh-copy f6" for="last_name">{{ trans('employee.new_lastname') }}</label>
          <input type="text" name="last_name" class="br2 f5 w-100 ba b--black-40 pa2 outline-0" value="{{ old('last_name') }}" required>
        </div>
