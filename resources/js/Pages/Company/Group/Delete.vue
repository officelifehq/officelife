    ...
    <div class="ph2 ph0-ns">
      ...
      <div class="mt4-l mt1 mw6 br3 bg-white box center breadcrumb relative z-0 f6 pb2">
        <ul class="list ph0 tc-l tl">
          ...
          <li class="di">
            <inertia-link :href="'/' + $page.props.auth.company.id + '/company/groups/' + group.id">{{ $t('app.breadcrumb_group_detail') }}</inertia-link>
          </li>
          <li class="di">
            {{ $t('app.breadcrumb_group_delete') }}
          </li>
        </ul>
      </div>
        ...
        <div class="mt5">
          ...
          <form @submit.prevent="submit">
            ...
            <div class="cf pa3 bb-gray bb">
              <p class="lh-copy">{{ $t('group.delete_description') }}</p>
            </div>
            ...
            <div class="cf pa3 bb-gray bb">
              <div class="flex-ns justify-between">
                <div>
                  <inertia-link :href="'/' + $page.props.auth.company.id + '/company/groups/' + group.id" class="btn dib tc w-auto-ns w-100 pv2 ph3 mb0-ns mb2" data-cy="cancel-button">
                    {{ $t('app.cancel') }}
                  </inertia-link>
                </div>
