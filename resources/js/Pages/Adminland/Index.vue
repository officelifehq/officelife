        ...
        <div class="pa3 mt5">
          ...
          <ul class="options list pl0 mb5">
            <li class="pa2 pl0 relative">
              🤖 <inertia-link :href="route('account.employees.index', $page.auth.company.id)" data-cy="employee-admin-link">
            ...
            <li class="pa2 pl0 relative">
              💵 <inertia-link :href="'/' + $page.auth.company.id + '/account/expenses'" data-cy="expenses-admin-link">
