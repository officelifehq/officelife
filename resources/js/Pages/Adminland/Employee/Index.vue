    ...
    <div class="ph2 ph0-ns">
      ...
      <div class="mw7 center br3 mb5 bg-white box restricted relative z-1">
        <div class="pa3 mt5">
          ...
          <ul class="list pl3">
            <li class="mb5"><span class="mr1">🧸</span> <inertia-link :href="statistics.url_new">{{ $t('account.employees_cta') }}</inertia-link></li>
            <li class="mb3 gray f6">{{ $t('account.employees_description') }}</li>
            <li class="mb3"><span class="mr1">👉</span> <inertia-link :href="statistics.url_all">{{ $t('account.employees_cta_view_all_employees', { count: statistics.number_of_employees }) }}</inertia-link></li>
            <li class="mb3">
              <span class="mr1">👉</span>
            ...
            <li class="mb3"><span class="mr1">👉</span> <inertia-link :href="statistics.url_permission">{{ $t('account.employees_cta_view_employees_permission') }}</inertia-link></li>
          </ul>
        </div>
      </div>
    </div>
