    ...
    <div class="ph2 ph0-ns">
      ...
      <div class="mt4-l mt1 mw6 br3 bg-white box center breadcrumb relative z-0 f6 pb2">
        <ul class="list ph0 tc-l tl">
          ...
          <li class="di">
            <inertia-link :href="$route('account.employees.index', $page.props.auth.company.id)">{{ $t('app.breadcrumb_employee_list') }}</inertia-link>
          </li>
          <li class="di">
          ...
          <form @submit.prevent="submit">
            ...
            <div class="cf pa3 bb-gray bb">
              <div class="flex-ns justify-between">
                <div>
                  <inertia-link :href="$route('account.employees.index', $page.props.auth.company.id)" class="btn dib tc w-auto-ns w-100 pv2 ph3 mb0-ns mb2" data-cy="cancel-button">
                    {{ $t('app.cancel') }}
                  </inertia-link>
                </div>
...
export default {
  ...
  methods: {
    submit() {
      ...
      axios.put(this.$route('account.employees.lock.update', [this.$page.props.auth.company.id, this.employee.id]))
        .then(response => {
