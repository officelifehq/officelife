      ...
      <div class="cf mw7 center br3 mb4 bg-white box relative">
        ...
        <div class="pa3 actions">
          <div class="flex justify-center">
            ...
            <a class="btn dib tc w-auto-ns w-100 pv2 ph3 mr2 destroy">{{ $t('dashboard.hr_discipline_case_show_case_deleted_cta') }}</a>
          </div>
        </div>
      </div>
        ...
        <div v-if="showAddMode" class="cf mw7 center bg-white box pa3 mb5">
          <form @submit.prevent="submit">
            ...
            <div class="flex-ns justify-between">
              ...
              <loading-button :class="'btn add w-auto-ns w-100 pv2 ph3'" :state="loadingState" :text="$t('account.employees_invite_cta')" />
            </div>
          </form>
        </div>
