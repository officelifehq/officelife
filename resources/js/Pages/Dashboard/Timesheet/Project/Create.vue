    ...
    <div class="ph2 ph0-ns">
      ...
      <div class="mt4-l mt1 mw6 br3 bg-white box center breadcrumb relative z-0 f6 pb2">
        <ul class="list ph0 tc-l tl">
          <li class="di">
            <inertia-link :href="route('dashboard.timesheet.index', { company: $page.props.auth.company.id })">{{ $t('app.breadcrumb_dashboard_timesheets') }}</inertia-link>
          </li>
          <li class="di">
          ...
          <form @submit.prevent="submit">
            ...
            <div class="mb4 mt5">
              <div class="flex-ns justify-between">
                <div>
                  <inertia-link :href="route('dashboard.timesheet.index', { company: $page.props.auth.company.id })" class="btn dib tc w-auto-ns w-100 mb2 pv2 ph3">
                    {{ $t('app.cancel') }}
                  </inertia-link>
                </div>
...
export default {
  ...
  methods: {
    submit() {
      ...
      axios.post(route('dashboard.timesheet.projects.store', { company: this.$page.props.auth.company.id }), this.form)
        .then(response => {
    ...
    search: _.debounce(
      function() {
        ...
        if (this.form.searchTerm != '') {
          ...
          axios.post(route('company.projects.search', { company: this.$page.props.auth.company.id }), this.form)
            .then(response => {
