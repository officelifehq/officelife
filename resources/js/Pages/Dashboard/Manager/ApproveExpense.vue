...
export default {
  ...
  methods: {
    accept() {
      ...
      axios.put('/' + this.$page.props.auth.company.id + '/dashboard/manager/expenses/' + this.expense.id + '/accept')
        .then(response => {
    ...
    reject() {
      ...
      axios.put('/' + this.$page.props.auth.company.id + '/dashboard/manager/expenses/' + this.expense.id + '/reject', this.form)
        .then(response => {
