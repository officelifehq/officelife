...
export default {
  ...
  methods: {
    ...
    update(itemId) {
      ...
      axios.put('/' + this.$page.props.auth.company.id + '/dashboard/oneonones/' + this.entry.id + '/actionItems/' + itemId, this.form)
        .then(response => {
    ...
    toggle(id) {
      axios.put('/' + this.$page.props.auth.company.id + '/dashboard/oneonones/' + this.entry.id + '/actionItems/' + id + '/toggle')
        .then(response => {
        })
        .catch(error => {
          this.form.errors = _.flatten(_.toArray(error.response.data));
