<template>
  <div class="cf mw7 center br3 mb5 tc">
    <div class="cf dib btn-group">
      ...
      <inertia-link v-if="employee.is_manager" :href="'/' + $page.auth.company.id + '/dashboard/manager'" class="f6 fl ph3 pv2 dib pointer" :class="{'selected':(employee.dashboard_view == 'expenses')}" data-cy="dashboard-expenses-tab">
      ...
      <inertia-link :href="'/' + $page.auth.company.id + '/dashboard/hr'" class="f6 fl ph3 pv2 dib pointer" :class="{'selected':(employee.dashboard_view == 'hr')}" data-cy="dashboard-hr-tab">
        HR area
      </inertia-link>
    </div>
  </div>
