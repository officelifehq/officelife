...
export default {
  ...
  methods: {
    ...
    search: _.debounce(
      function () {
        if (this.form.searchTerm !== '') {
          ...
          axios.post(this.$route('employees.skills.search', [this.$page.props.auth.company.id, this.employee.id]), this.form)
            .then(response => {
    ...
    create(name) {
      ...
      axios.post(this.$route('employees.skills.store', [this.$page.props.auth.company.id, this.employee.id]), { searchTerm: name })
        .then(response => {
    ...
    remove(skill) {
      ...
      axios.delete(this.$route('employees.skills.destroy', [this.$page.props.auth.company.id, this.employee.id, skill.id]))
        .then(response => {
