      ...
      <div class="cf mw9 center">
        ...
        <div v-if="permissions.can_see_performance_tab && surveys" class="cf mw7 center br3 mt3 mb5 tc" data-cy="employee-tab">
          <div class="cf dib btn-group">
            ...
            <inertia-link :href="'/' + $page.auth.company.id + '/employees/' + employee.id + '/performance'" class="f6 fl ph3 pv2 dib pointer" :class="{'selected':(menu == 'performance')}" data-cy="performance-tab">
