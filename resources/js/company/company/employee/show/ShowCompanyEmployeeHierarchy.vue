...
<template>
  <div class="mb4 relative">
    ...
    <!-- ADD MANAGER -->
    <div class="popupmenu absolute br2 bg-white z-max tl pv2 ph3 bounceIn faster" v-if="modal == 'manager'" v-click-outside="toggleModals">
    ...
    <!-- ADD DIRECT REPORT -->
    <div class="popupmenu absolute br2 bg-white z-max tl pv2 ph3 bounceIn faster" v-if="modal == 'directReport'" v-click-outside="toggleModals">
      <form @submit.prevent="search">
        <div class="mb3 relative">
